...
[![Databricks Runtime](https://img.shields.io/badge/Databricks-17.3_LTS-orange)](https://docs.databricks.com/en/release-notes/runtime/17.3lts.html)
...
## EMAIL ALERT 
 - sending daily email in case an alarm get detected including all day analyses 
 - modern  UI (using html,css ) with clear color panel
 - make sure you change receipents_list and cc_list variables 
 - configure your account Credentials ( username ,password )
## Roadmap
